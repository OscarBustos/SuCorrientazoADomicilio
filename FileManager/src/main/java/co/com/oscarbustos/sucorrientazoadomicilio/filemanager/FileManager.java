package co.com.oscarbustos.sucorrientazoadomicilio.filemanager;
...
public class FileManager {
	...
	public static boolean moveFile(Path file, Path processedOrdersDirectory) throws IOException {
		...
		createDirectory(processedOrdersDirectory.toString().substring(0,
				processedOrdersDirectory.toString().lastIndexOf("\\")));
	...
	public static void write(String line, String fileName) throws IOException {
		...
		BufferedWriter writer = getBufferedWriter(file.toPath());
